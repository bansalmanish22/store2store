...
if submit_button:
    with st.spinner('Wait for it...'):
        ...
        link_to_gglsht = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQ7R_xjkP2QsvsVQl_nMjrncrGKCyK9KsiQA5hoNBFaHr9KFQzl0stU_CkC3P2rOBs3SMdvIigflVBe/pub?output=xlsx'
        try:
